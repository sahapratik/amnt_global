        ...
        >
          <div style={{ width: 'min(640px, 90vw)', textAlign: 'center' }}>
            <p style={{
              ...
              color: 'var(--rose)', marginBottom: '24px',
            }}>
              Search Collection
            </p>
            <input
              ...
              style={{
                ...
                border: 'none', borderBottom: '1px solid rgba(232,228,221,0.3)',
                color: 'var(--offwhite)', fontFamily: 'Cormorant Garamond, serif',
                fontSize: 'clamp(22px, 4vw, 36px)', fontWeight: 300,
                fontStyle: 'italic', letterSpacing: '0.04em',
                padding: '12px 0', outline: 'none', textAlign: 'center',
                cursor: 'text',
              }}
            />
